...
# DOWNLOAD_TCGA="cd 1_download_tcga_bc && bash download_tcga_bc_subset_5.sh && cd .."
...
# DOWNLOAD_TCGACRCK="cd 2_download_tcga_crck && bash download_tcga_crck.sh & cd .."
...
run_line "bash extract_ssl_features_tcga_bc.sh"
...
do
    ...
    run_line "extract_ssl_features_tcga_bc.sh ${FOLD}" $EXECLINE
done
